...
<form method="post" enctype="multipart/form-data">
  <?php wp_nonce_field( PWS_BOOKING_NONCE_ACTION ); ?>
  <input type="file" id="<?php echo esc_attr( PWS_BOOKING_FILE_FIELD ); ?>" name="<?php echo esc_attr( PWS_BOOKING_FILE_FIELD ); ?>" accept=".xlsx">
